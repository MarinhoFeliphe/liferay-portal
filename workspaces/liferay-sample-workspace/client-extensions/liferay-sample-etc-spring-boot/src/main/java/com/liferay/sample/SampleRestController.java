...
public class SampleRestController {
	...
	public ResponseEntity<String> postSampleObjectEntryManager1Patch(
		...
		JSONObject objectEntryJSONObject = _objectEntryJSONObjects.put(
			String.valueOf(jsonObject.get("externalReferenceCode")),
			new JSONObject(
				jsonObject.get(
					"objectEntry"
	...
	private static final Map<String, JSONObject> _objectEntryJSONObjects =
		HashMapBuilder.<String, JSONObject>put(
			...
			new JSONObject(
				...
				"dateCreated", "2023-05-18T03:02:32Z"
			).put(
				"dateModified", "2023-05-18T03:02:32Z"
			).put(
				"externalReferenceCode", "item-1"
			).put(
				"textCustomObjectField", "Text Custom Object Field Value"
			)
		).build();
