...
public abstract class BaseTaskResourceTestCase {
	...
	public void testPostTask() throws Exception {
		...
		Task task = testPostTask_addTask();

		assertHttpResponseStatusCode(
			204, taskResource.postTaskHttpResponse(null, task));

		assertHttpResponseStatusCode(
			404, taskResource.postTaskHttpResponse(null, task));
	}

	protected Task testPostTask_addTask() throws Exception {
