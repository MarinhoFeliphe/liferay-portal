...
async function getAgentDefinition(externalReferenceCode: string) {
	const response = await fetch(`/o/ai-hub/agent-definitions/by-external-reference-code/${externalReferenceCode}`, {
		method: 'GET',
	});
...
async function putAgentDefinition(agentDefinition: AgentDefinition) {
	const response = await fetch(`/o/ai-hub/agent-definitions/by-external-reference-code/${agentDefinition.externalReferenceCode}`, {
