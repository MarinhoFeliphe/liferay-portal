 ...
 */
public class ImproveWritingAgent implements AgentSpecsProvider {

	public ImproveWritingAgent(
	...
	public String description() {
		return "This writing agent improves text eliminating wordiness and " +
			"passive voice to deliver a clear, direct message.";
	}
		...
		try {
			...
			WorkflowInstance workflowInstance =
				_workflowInstanceManager.startWorkflowInstance(
					...
					WorkflowDefinitionConstants.NAME_IMPROVE_WRITING, 1, null,
