 ...
 */
public class ChangeToneAgent implements AgentSpecsProvider {

	public ChangeToneAgent(
	...
	public String description() {
		return "This writing agent adapts a given text to fit any tone you " +
			"specify as input.";
	}
		...
		try {
			...
			WorkflowInstance workflowInstance =
				_workflowInstanceManager.startWorkflowInstance(
					...
					WorkflowDefinitionConstants.NAME_CHANGE_TONE, 1, null,
					HashMapBuilder.<String, Serializable>put(
						...
						"tone", GetterUtil.getString(input.get("tone"))
					).build());
