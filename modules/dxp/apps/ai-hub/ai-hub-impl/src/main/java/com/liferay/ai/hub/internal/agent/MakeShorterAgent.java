 ...
 */
public class MakeShorterAgent implements AgentSpecsProvider {

	public MakeShorterAgent(
	...
	public String description() {
		return "This writing agent takes your text and rewrites it to be " +
			"briefer and easier to read.";
	}
		...
		try {
			...
			WorkflowInstance workflowInstance =
				_workflowInstanceManager.startWorkflowInstance(
					...
					WorkflowDefinitionConstants.NAME_MAKE_SHORTER, 1, null,
