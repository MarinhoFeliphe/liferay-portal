...
public class ScriptManagementConfigurationUpgradeProcessTest {
	...
	@Test
	public void testDoUpgradeUnsafeResourceActiveGroovyObjectAction() throws Exception {
		_testDoUpgrade(() -> _addObjectAction(
	...
	@Test
	public void testDoUpgradeUnsafeResourceActiveGroovyObjectValidation() throws Exception {
		_testDoUpgrade(() -> _addObjectValidationRule(
	...
	@Test
	public void testDoUpgradeUnsafeResourcePublishedGroovyWorkflowDefinition() throws Exception {
		_testDoUpgrade(() -> _workflowDefinitionManager.deployWorkflowDefinition(
			TestPropsValues.getCompanyId(), TestPropsValues.getUserId(),
	...
	@Test
	public void testDoUpgradeUnsafeResourcePublishedJavaWorkflowDefinition() throws Exception {
		_testDoUpgrade(() -> _workflowDefinitionManager.deployWorkflowDefinition(
			TestPropsValues.getCompanyId(), TestPropsValues.getUserId(),
			StringUtil.randomId(), StringUtil.randomId(),
			_getContentBytes("workflow-definition-3.json")));
	...
	private void _testDoUpgrade(UnsafeRunnable<Exception> runnable)
		throws Exception {
		try (Closeable closeable =
				 ScriptManagementConfigurationTestUtil.saveWithCloseable(true)) {
