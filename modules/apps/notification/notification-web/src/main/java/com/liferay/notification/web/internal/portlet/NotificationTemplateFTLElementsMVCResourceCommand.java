...
public class NotificationTemplateFTLElementsMVCResourceCommand
	...
	protected void doServeResource(
		...
		for (TemplateVariableGroup templateVariableGroup :
			...
			_prepareJSONObject(false, jsonArray, locale, templateVariableGroup);
		}
		...
		for (InfoFieldSetEntry infoFieldSetEntry :
			...
			_prepareJSONObject(true, jsonArray, locale, templateVariableGroup);
		}
	...
	private void _prepareJSONObject(
			boolean infoField, JSONArray jsonArray, Locale locale,
			TemplateVariableGroup templateVariableGroup)
		throws Exception {
