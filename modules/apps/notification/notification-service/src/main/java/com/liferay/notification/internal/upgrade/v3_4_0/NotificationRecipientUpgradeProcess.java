...
public class NotificationRecipientUpgradeProcess extends UpgradeProcess {
	...
	protected void doUpgrade() throws Exception {
		//TODO check if the upgrade should be execute
	...
	private Long _getNotificationRecipientId(
		...
		throw new UpgradeException(
			"Please manually re-create recipient data in your Notifications " +
			"portlet, as this data was erroneously deleted during a previous " +
			"upgrade process");
	}
