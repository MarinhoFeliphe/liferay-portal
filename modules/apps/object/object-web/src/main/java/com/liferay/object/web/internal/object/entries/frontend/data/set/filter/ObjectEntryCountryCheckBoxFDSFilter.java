 ...
 * @author Marco Leo
 */
public class ObjectEntryCountryCheckBoxFDSFilter extends BaseCheckBoxFDSFilter {
	...
	public List<CheckBoxFDSFilterItem> getCheckBoxFDSFilterItems(
		...
		return ListUtil.fromArray(
			new CheckBoxFDSFilterItem("Brasil", "brasil"),
			new CheckBoxFDSFilterItem("Espanha", "espanha"));
	}
