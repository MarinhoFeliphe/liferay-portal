...
page import="com.liferay.object.web.internal.object.entries.display.context.ViewObjectEntryDisplayContext" %><%@
page import="com.liferay.object.web.internal.object.entries.display.context.ViewObjectEntryDisplayContextProviderUtil" %><%@
