...
import com.liferay.object.internal.info.collection.provider.ManyToManyObjectRelationshipInfoCollectionProvider;
import com.liferay.object.internal.info.collection.provider.ObjectEntrySingleFormVariationInfoCollectionProvider;
import com.liferay.object.internal.info.collection.provider.OneToManyObjectRelationshipInfoCollectionProvider;
			...
			try {
				if (Objects.equals(
					...
					_bundleContext.registerService(
						...
						new ManyToManyObjectRelationshipInfoCollectionProvider(
					...
					_bundleContext.registerService(
						RelatedInfoItemCollectionProvider.class,
						new OneToManyObjectRelationshipInfoCollectionProvider(
							objectDefinition, _objectDefinitionLocalService,
							_objectEntryLocalService, objectRelationship),
						HashMapDictionaryBuilder.<String, Object>put(
							"company.id", objectDefinition.getCompanyId()
