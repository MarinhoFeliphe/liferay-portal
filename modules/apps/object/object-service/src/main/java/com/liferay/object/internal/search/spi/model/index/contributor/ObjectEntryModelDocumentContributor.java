...
public class ObjectEntryModelDocumentContributor
	...
	private void _contribute(
		...
		Object fieldValue, ObjectDefinition objectDefinition,
		...
		if (StringUtil.equals(
			...
			fieldValue = ObjectEntryValuesUtil.getValueString(objectField, values);
		}
		else if (StringUtil.equals(
					objectField.getBusinessType(),
					ObjectFieldConstants.BUSINESS_TYPE_PRECISION_DECIMAL)) {

			fieldValue = BigDecimalUtil.stripTrailingZeros((BigDecimal)fieldValue);
		}
		...
		if (objectField.isIndexedAsKeyword()) {
			...
			_addField(
				fieldArray, fieldName, "value_boolean", valueString);
			_addField(
				fieldArray, fieldName, "value_keyword",
			...
			_addField(
				fieldArray, fieldName, "value_integer", valueString);
			...
			if (Validator.isBlank(objectField.getIndexedLanguageId())) {
				_addField(
					fieldArray, fieldName, "value_text", valueString);
			}
			else {
				_addField(
